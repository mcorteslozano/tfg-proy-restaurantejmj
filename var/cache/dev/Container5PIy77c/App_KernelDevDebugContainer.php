...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getSecurity_AccessMapService()
    {
        ...
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/articulo'), [0 => 'ROLE_ENCARGADO'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/proveedor'), [0 => 'ROLE_ENCARGADO'], NULL);
        $instance->add(new \Symfony\Component\HttpFoundation\RequestMatcher('^/pedido'), [0 => 'ROLE_ENCARGADO'], NULL);
