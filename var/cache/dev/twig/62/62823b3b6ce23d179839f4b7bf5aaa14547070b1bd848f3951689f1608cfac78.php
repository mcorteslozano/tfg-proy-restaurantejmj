...
";
        // line 8
        echo         $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->renderBlock((isset($context["contactoForm"]) || array_key_exists("contactoForm", $context) ? $context["contactoForm"] : (function () { throw new RuntimeError('Variable "contactoForm" does not exist.', 8, $this->source); })()), 'form');
        echo "
...
{% block title %}Restaurante JMJ{% endblock %}
...
{% endblock %}
", "contacto/index.html.twig", "C:\\xampp\\htdocs\\restaurante2\\templates\\contacto\\index.html.twig");
    }
}
