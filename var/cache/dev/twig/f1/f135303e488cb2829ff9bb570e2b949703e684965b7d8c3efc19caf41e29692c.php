...
class __TwigTemplate_838ec8a74b1bccebe90ddcafa311f45d6f7b4b7f51f8321e0428495186573b0e extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 9
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 9, $this->source); })()), "roles", [], "any", false, false, false, 9), 'row');
        echo "
...
";
    ...
    {
        return array (  106 => 12,  100 => 9,  96 => 8,  92 => 7,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{{ form_end(form) }}
{% endblock %}
", "register/index.html.twig", "C:\\xampp\\htdocs\\restaurante2\\templates\\register\\index.html.twig");
    }
}
