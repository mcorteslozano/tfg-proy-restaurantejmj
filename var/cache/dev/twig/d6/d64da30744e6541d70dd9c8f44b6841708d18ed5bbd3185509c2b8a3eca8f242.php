...
class __TwigTemplate_62372c6aca7f4e1ca6fd887dba3aea8b3e9e9898d0b7023351118fda5579e3ee extends Template
{
    private $source;
    private $macros = [];
    ...
    <div id=\"botones_editar\">
        <button class=\"btn\">";
        // line 4
        echo twig_escape_filter($this->env, (((isset($context["button_label"]) || array_key_exists("button_label", $context))) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Guardar Cambios")) : ("Guardar Cambios")), "html", null, true);
        echo "</button>
";
        // line 5
...
";
    ...
    {{ form_widget(form) }}
    <div id=\"botones_editar\">
        <button class=\"btn\">{{ button_label|default('Guardar Cambios') }}</button>
{{ form_end(form) }}
", "usuario/_form.html.twig", "C:\\xampp\\htdocs\\restaurante\\templates\\usuario\\_form.html.twig");
    }
}
